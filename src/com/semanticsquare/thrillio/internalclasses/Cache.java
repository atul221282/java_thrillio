...
public class Cache {		
    ...
    public CacheIterator3 iterator() {
    	return new MyCacheIterator();    	
    }
    
    private class MyCacheIterator implements CacheIterator3 {
    	private int i = 0;
    ...
    public static void main(String[] args) {
		...
		CacheIterator3 iterator = recommendedItems.iterator();
