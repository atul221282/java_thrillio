package com.semanticsquare.thrillio.datetime;
...
public class OldDateTimeApiDemo {
	...
	private static void testLegacyDateAPI() {
		...
		+ (gameStartTime.get(Calendar.MONTH) + 1) + "/" 
				+ gameStartTime.get(Calendar.DAY_OF_MONTH) + " at " 
		+ gameStartTime.get(Calendar.HOUR) + ":" 
				+ gameStartTime.get(Calendar.MINUTE) 
